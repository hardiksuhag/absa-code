...
python3 ate_crf_detect.py $testPath/term_test.csv  $outputPath/ate_result_parse.txt  $outputPath/ate_result_map.txt
python3 evaluation/ate_evaluation.py  $outputPath/ate_result_map.txt $rawData/aspect_term.csv
